...
export default async function Page({ params }) {
  ...
  return (
    <div className="mx-auto mt-8 max-w-6xl">
      <div className="mb-24 grid grid-cols-[3fr_4fr] gap-20 border border-stone-800 px-10 py-3">
        ...
        <div>
          ...
          <p className="mb-10 text-lg text-stone-300">{description}</p>
          ...
          <ul className="mb-7 flex flex-col gap-4">
            ...
            <li className="flex items-center gap-3">
              <EyeSlashIcon className="h-5 w-5 text-stone-600" />
              <span className="text-lg">
